...
from .serializers import (
    ...
    NotificationMessageResponseSerializer,
...
@extend_schema(
    request=None,
    responses={200: NotificationMessageResponseSerializer},
)
@api_view(['POST'])
@permission_classes([permissions.IsAuthenticated])
...
@extend_schema(responses={200: NotificationCountResponseSerializer})
@api_view(['GET'])
@permission_classes([permissions.IsAuthenticated])
...
@extend_schema(responses={200: NotificationMessageResponseSerializer})
@api_view(['DELETE'])
@permission_classes([permissions.IsAuthenticated])
