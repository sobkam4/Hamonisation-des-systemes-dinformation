...
from .serializers import (
    ...
    PaiementStatisticsSerializer,
    GenererEcheancesResponseSerializer,
    GenererEcheancesErrorSerializer,
    PaiementGenererReferenceResponseSerializer,
)
...
@extend_schema(
    request=None,
    responses={200: PaiementGenererReferenceResponseSerializer},
)
...
@extend_schema(responses={200: PaiementStatisticsSerializer})
@api_view(['GET'])
@permission_classes([permissions.IsAuthenticated])
...
@extend_schema(
    request=None,
    responses={
        200: GenererEcheancesResponseSerializer,
        400: GenererEcheancesErrorSerializer,
        404: GenererEcheancesErrorSerializer,
    },
)
@api_view(['POST'])
@permission_classes([permissions.IsAuthenticated])
